...
************************************************************/
	...
	************************************************************/
	...
	define('PROJECT_NAME','labosearch Ltd.');

	define('WEBSITE_LINK','https://www.labosearch.com/');

	define('WEBSITE_TNC','<p>• labosearch Ltd.<br>• Bank Name: Royal Bank of Canada<br>• USD Account Number: 4006193<br>• Swift Code: ROYCCAT2<br>• Branch address: Northland Plaza BR 4820 Northland DR NW Suite 220 Calgary AB T2L 2L3<br>• Products shipment will be 4 weeks from the date of receipt of payment<br>• Quotation Validity: 60 days<br>• Warranty: One year from the date of shipment, against any manufacturing defects<br>• 100 % advance payment by wire transfer</p>');
