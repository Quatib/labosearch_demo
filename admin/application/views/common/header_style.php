...
<title> <?php echo bsnprm_value(BSN_WEBSITE_NAME) ?><?php echo (isset($title) && !empty($title))?" | ".$title:''; ?></title>
...
<link href="<?php echo base_url()?>assets/layouts/layout/css/custom.css<?php echo $globalCacheHVersion; ?>" rel="stylesheet" type="text/css" />
  ...
  <link href="<?php echo base_url()?>assets/global/plugins/bootstrap-toastr/toastr.min.css<?php echo $globalCacheHVersion; ?>" rel="stylesheet" type="text/css" />
...
<?php 
    ...
    $website_image_path             = $urlString.'/'.FAVICON_IMAGE_PATH;

    $website_image                  = bsnprm_value(BSN_WEBSITE_LINK).FAVICON_IMAGE_PATH; ?>

<link rel="shortcut icon" type="image/png" href="<?php echo (file_exists($website_image_path))?$website_image:''; ?>" />
